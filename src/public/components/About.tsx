  ...
  return (
    <div className="container">
      <div>
        ...
        <h3 className="stated-mystery">Resources</h3>
        <a className="desc" href="https://thenounproject.com/tivilupercio/" target="_blank" style={{color: 'black'}}>Favicon by Tivi Lupercio Ordoñez</a>
