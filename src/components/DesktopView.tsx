  ...
  return (
    <div id="desktop-view" className="container">
      <div>
        ...
        <p className="desc desc--italic desc--desktop" style={{ textAlign: 'center' }}>
          Rediscover the Rosary with Scripture and Meditation
        </p>
      </div>
      ...
      <section className="section--desktop">
        ...
        <img src="" alt="GIF of Connecting The Beads in action" />
      </section>
      <p className="desc desc--desktop">
        You can view Connecting The Beads (in portrait orientation) on any smartphone or tablet running at least
        iOS 12.2 or Chrome 51, or shrink your desktop browser to view the app.
